...
input_dict = {
    'idade': idade,
    'sexo': sexo_bin,
    'dor_lombar_noturna': int(dor_lombar_noturna),
    'rigidez_matinal': int(rigidez_matinal),
    'hla_b27': int(hla_b27),
    'vhs': vhs,
    'pcr': pcr,
    'hist_familiar': int(hist_familiar),
    'resposta_aine': int(resposta_aine),
    'rm_sacroiliaca': int(rm_sacroiliaca)
}
